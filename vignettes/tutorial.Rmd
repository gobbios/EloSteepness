...
elo_res <- elo_steepness_from_matrix(mat = mat, n_rand = 3, refresh = 0, cores = 4)
```
...
elo_res_half <- elo_steepness_from_matrix(mat = mat1, n_rand = 3, refresh = 0, cores = 4)
elo_res_doubled <- elo_steepness_from_matrix(mat = mat2, n_rand = 3, refresh = 0, cores = 4)
```
...
m5 <- m1 * 5
# calculate steepness
r1 <- elo_steepness_from_matrix(mat = m1, n_rand = 5, cores = 4)
r2 <- elo_steepness_from_matrix(mat = m2, n_rand = 5, cores = 4)
r5 <- elo_steepness_from_matrix(mat = m5, n_rand = 5, cores = 4)
```
