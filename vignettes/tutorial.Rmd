...
To make this data set a bit more manageable, we reduce the original sequence to 200 interactions, which occur among `r length(unique(c(s$Winner, s$Loser)))` males.
...
To be explicit, the function that calculates ratings, cumulative winning probabilities and steepness is `elo_steepness_from_sequence()`.
