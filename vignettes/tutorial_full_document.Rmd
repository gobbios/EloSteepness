...
In order to get the package up and running you need a working installation of `rstan`.
...
```{r elo_steep_01, eval = TRUE, cache=TRUE}
...
Their posteriors overlap extensively, although *b* has a slightly higher mean/median.
